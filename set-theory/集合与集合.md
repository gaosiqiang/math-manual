...
6、A$\bigcap$B = B$\bigcap$A；

7、A$\bigcap$$\emptyset$ = $\emptyset$；

8、A$\bigcup$A = A；

9、A$\bigcap$$\complement_{U}A$ = $\emptyset$；

10、A$\bigcup$$\complement_{U}A$ = U；

11、(A$\bigcap B$) $\subseteq$A$\subseteq$(A$\bigcup B$)

12、若A和B都是U的子集，则$\complement_{U}(A\bigcap B)$ = $\complement_{U}A$$\bigcup$$\complement_{U}A$；

13、若A和B都是U的子集，则$\complement_{U}(A\bigcup B)$ = $\complement_{U}A$$\bigcap$$\complement_{U}A$；

14、若A$\subseteq$B，则A$\bigcap$B=A；

15、若A$\subseteq$B，则A$\bigcup$B=B；
